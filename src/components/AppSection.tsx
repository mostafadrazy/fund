...
export default function AppSection() {
  ...
  return (
    <section ref={ref} className="relative w-full bg-[#F7F6F2] overflow-hidden py-8 lg:py-10 flex items-end lg:items-center border-t border-black/5">
      {/* Desktop Background Image: fit to section with object-contain, no zoom, uncropped */}
      <motion.div style={{ y: yImage }} className="hidden lg:flex absolute inset-0 w-full h-full pointer-events-none items-end justify-end overflow-hidden">
        <div className="w-full h-full max-w-[96rem] mx-auto relative flex items-end justify-end pl-6 sm:pl-8 pr-0">
          <motion.img 
            ...
            className="w-full h-full object-contain object-right-bottom translate-x-12 lg:translate-x-20"
          />
        </div>
      </motion.div>
      ...
      <div className="relative z-10 max-w-[84rem] mx-auto px-6 sm:px-8 md:px-12 w-full">
        <motion.div 
          ...
          className="w-full max-w-xl lg:max-w-md xl:max-w-lg 2xl:max-w-xl"
        >
          ...
          <h2 className="text-[var(--color-mizan-dark)] text-4xl sm:text-5xl font-serif font-bold leading-[1.12] mb-4">
            Our First Step Into<br className="hidden sm:inline" /> Redirecting Community Capital
          </h2>
          
          <p className="text-gray-700 text-base sm:text-lg leading-relaxed font-medium mb-8 max-w-xl">
        ...
        >
          <img 
            src="https://res.cloudinary.com/dmnqlruhl/image/upload/v1788389881/Woman_holding_phone_and_cards_202609022350-_1_k2oj3y.png" 
            alt="Mizan Capital iOS app preview" 
            className="w-full max-w-lg h-auto object-contain block translate-x-4 sm:translate-x-8"
          />
        </motion.div>
      </div>
    </section>
